...
public:
	...
	Vertex(const DirectX::XMFLOAT4& pos, const DirectX::XMFLOAT3& n, const DirectX::XMFLOAT2& t, const DirectX::XMFLOAT3& tg, const DirectX::XMFLOAT4& color) : pos(pos), n(n), t(t), color(color), tg(tg) {}
