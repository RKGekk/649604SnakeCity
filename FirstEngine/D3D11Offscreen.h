...
class D3D11Offscreen : public D3D11Drawable {
...
public:
	...
	D3D11Offscreen(DirectX::XMFLOAT4X4* pMatrix, ID3D11Device* device, const std::wstring& ps_file);
	virtual ~D3D11Offscreen();
