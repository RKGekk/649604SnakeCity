...
bool SystemClass::Initialize() {
	...
	LPCWSTR a = L"open TLFN01SnakeCity.mp3 type mpegvideo";
	int error = 99;
	error = mciSendString(a, NULL, 0, 0);
	int error2;
	LPCWSTR b = L"play TLFN01SnakeCity.mp3";
...
GameTimer& SystemClass::GetGameTimer() {
	return m_applicationHandle->m_Timer;
}
